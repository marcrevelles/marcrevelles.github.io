...
![nvidia-smi persistence status](/assets/img/posts/nvidia_smi_persistence.png){: width="827" height="352" }
...
![Default output of Jellyfin's installation script](/assets/img/posts/jellyfin_helper_script.png){: width="1017" height="959" }
...
![Jellyfin's transcoding configuration - NVIDIA Quadro T600](/assets/img/posts/jellyfin_transcoding_settings.png){: width="1463" height="1244" }
...
![Live transcoding - Jellyfin's playback info](/assets/img/posts/jellyfin_live_transcoding.png){: width="817" height="686" }
...
![nvidia-smi usage while transcoding](/assets/img/posts/nvidia_smi_usage.png){: width="828" height="379" }
